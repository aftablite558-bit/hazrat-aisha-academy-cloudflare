...
import { PremiumCard, PremiumButton } from '../common/PremiumComponents';
  ...
  return (
    <section className="py-24 px-6 relative z-10 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        <PremiumCard variant="luxury" glow="emerald" gradientBorder className="p-8 sm:p-14 relative overflow-hidden border-emerald-500/30">
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto space-y-6">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-emerald-500/15 border border-emerald-500/30 text-amber-300 text-xs font-extrabold uppercase tracking-widest shadow-md"
            >
            ...
            >
              ...
              >
                <PremiumButton 
                  variant="ghost" 
                  size="lg"
                  className="w-full sm:w-auto text-amber-300"

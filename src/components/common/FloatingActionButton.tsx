...
export const FloatingActionButton = ({ className, icon, ...props }: FABProps) => {
  return (
    <motion.button
      ...
      className={cn(
        'fixed bottom-8 right-8 z-50 w-14 h-14 rounded-full bg-gradient-to-tr from-emerald-600 via-emerald-500 to-amber-500 text-white shadow-[0_10px_35px_rgba(0,0,0,0.2),0_0_20px_rgba(16,185,129,0.4)] hover:shadow-[0_15px_45px_rgba(0,0,0,0.3),0_0_30px_rgba(16,185,129,0.6)] flex items-center justify-center border border-white/20 transition-all duration-300 group',
        className
      )}
      {...props}
    >

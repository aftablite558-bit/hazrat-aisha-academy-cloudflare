...
export const GlassButton = ({ variant = 'primary', className, children, ...props }: ButtonProps) => {
  const variants = {
    primary: 'bg-gradient-to-r from-emerald-600 via-emerald-500 to-teal-600 backdrop-blur-xl border border-emerald-400/50 shadow-[0_0_20px_rgba(16,185,129,0.35),inset_0_2px_4px_rgba(255,255,255,0.4)] text-white hover:shadow-[0_15px_45px_rgba(0,0,0,0.15),0_0_30px_rgba(16,185,129,0.6)] relative overflow-hidden group',

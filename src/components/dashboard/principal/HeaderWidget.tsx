...
export const HeaderWidget: React.FC<HeaderWidgetProps> = ({
  ...
  return (
    <GlassCard className="p-6 md:p-8 relative overflow-hidden bg-gradient-to-r from-primary-500/10 via-primary-500/5 to-secondary-500/10 border-primary-500/20 shadow-xl">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
        ...
        <div className="flex items-center gap-5">
          <div className="relative">
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-white dark:bg-slate-800 p-2 shadow-md border border-primary-500/30 flex items-center justify-center overflow-hidden">
              <img
                src="/assets/logo.png"
              ...
              />
              <span className="text-2xl font-black text-primary-500 select-none">HAA</span>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs px-2 py-0.5 rounded-full bg-primary-500/10 text-primary-600 dark:text-primary-400 font-bold border border-primary-500/20 uppercase tracking-wider">
                {role}
              </span>
            </div>
